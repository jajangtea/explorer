...
class Dashboard_studio extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('Studio_model', 'am');
    ...
    public function index()
    {
        ...
        $this->template->load('template_frontend/template_v', 'dashboard/studio_v', $data);
    ...
    public function cari()
    {
        ...
        $studio = $this->am->get_studio_search($nama);
        $data = array(
            'title' => $jenis,
            'travel_agent_data' => $travel_agent,
            'studio' => $studio
