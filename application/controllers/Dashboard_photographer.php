...
class Dashboard_photographer extends CI_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('Photographer_model', 'pm');
    ...
    public function index()
    {
        ...
        $photographer = $this->pm->get_photographer_profesional();
        $data = array(
            'ahli_data' => $ahli,
            'title' => $jenis,
        ...
        $this->template->load('template_frontend/template_v', 'dashboard/photographer_v', $data);
