                    ...
                    <div class="card-body">
                        ...
                        <form action="<?= base_url() . 'dashboard_pemandu/cari' ?>" method="POST">
                            <div class="form-group col-lg-12">
                                ...
                                <input type="text" class="form-control" name="nama" id="nama" placeholder="Nama Photographer Profesional" />
                            </div>
                            <div class="form-group col-lg-12">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php echo anchor("dashboard_photographer/read/{$ahli->id}", "<i class='feather icon-eye'></i>Detail", ['class' => 'btn btn-sm btn-gradient-info']) ?>
                                    </td>
                                </tr>
                            <?php
                            }
