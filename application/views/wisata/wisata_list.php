...
<html>
    ...
    <body>
		...
		<th>Action</th>
			...
			<td><?php echo $wisata->img ?></td>
			<td><?php echo $wisata->keterangan ?></td>
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('wisata/read/'.$wisata->id),'Read'); 
				echo ' | '; 
				echo anchor(site_url('wisata/update/'.$wisata->id),'Update'); 
				echo ' | '; 
				echo anchor(site_url('wisata/delete/'.$wisata->id),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr>
                <?php
		...
		<?php echo anchor(site_url('wisata/excel'), 'Excel', 'class="btn btn-primary"'); ?>
		<?php echo anchor(site_url('wisata/word'), 'Word', 'class="btn btn-primary"'); ?>
	    </div>
